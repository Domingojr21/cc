...
public void process(Exchange exchange) throws Exception {
    ...
    try {
        ...
        // Configurar mapper para manejar propiedades desconocidas
    ...
    if (service2Response.header().responseCode() != Constants.HTTP_OK) {
        logger.warn("Servicio maestro retornó código de error: {} - {}", 
    ...
    // Verificar si el cliente fue encontrado (código 000 = éxito, 904 = no encontrado)
